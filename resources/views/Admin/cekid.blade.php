...
@php
    ...
    <h2 style="margin-top: 10vh; font-size:2vw; color:#7969E8;">Cek ID Pesanan</h2>
        ...
        <input type="text" class="inputM" placeholder="ID Pesanan" required style="margin-top:3vh;">
        <br>
        <button onclick="cek()" class="prim-botton" name="cek" style=" padding: 5px 30px;">Cek</button>
    </form>
    </div>
